...
pacman -S --needed --noconfirm mingw-w64-x86_64-python mingw-w64-x86_64-python-pip \
    mingw-w64-x86_64-gexiv2 mingw-w64-x86_64-ghostscript mingw-w64-x86_64-python-cairo \
    mingw-w64-x86_64-python-gobject mingw-w64-x86_64-python-icu mingw-w64-x86_64-iso-codes \
    mingw-w64-x86_64-hunspell mingw-w64-x86_64-enchant perl-XML-Parser \
